...
//   document.write('<table id="myTable" width="10" height="1" bordercolor="00CC99" bgcolor="FFFF66" border="1">');
//     for(let row = 0; row < x ; row++) {
//     	document.write('<tr>');
//     		for(let col = 0; col < y ; col++) {
//     	  	document.write(`<td id="savetext${i},${j}">`); 
//             document.write('<form method="get">');
//               document.write(`<textarea id="text${row},${col}" rows="1" cols="10"></textarea>`);
//    						document.write(`<input type="button" value="Сохранить" onclick="SAVE(${row},${col});">`);
//             document.write('</form>');
//           document.write('</td>');
//       	}
//       document.write('</tr>');
...
// document.write('<input type="button" value="Сохранить" onclick="changeMe(12)">');
// changeMe(document.forms[',f,'].text.value);
// document.write('<input type="button" value="Сохранить" onclick="changeMe(document.forms[',f,'].text.value);">');
// changeMe(this.form.text.value);